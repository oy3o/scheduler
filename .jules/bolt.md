...
## 2025-06-08 - Early Return for Exact Percentiles in Linear Interpolation
**Learning:** When calculating percentiles with linear interpolation on unsorted slices, finding the upper bound for the fractional component (via `slices.Min`) is an O(N) operation.
